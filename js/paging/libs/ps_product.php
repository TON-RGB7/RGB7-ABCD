...
class PS_Pagination {
	...
	function renderFirst($tag = '«') {
		...
		if ($this->page == 1) {
            ...
            //default to one (1)
            return "<span> <a href='javascript:void(0);' OnClick='getdata( 1 )' title='First Page'>$tag</a></span>";
		}
	}
	...
	function renderLast($tag = '»') {
		...
		if ($this->page == $this->max_pages) {
            ...
            return " <span><a href='javascript:void(0);' OnClick='getdata( $pageno )' title='Last Page'>$tag</a></span> ";
		}
	}
	...
	function renderNext($tag = '›') {
		...
		if ($this->page < $this->max_pages) {
            ...
            $pageno = $this->page + 1;
            return "<span> <a href='javascript:void(0);' OnClick='getdata( $pageno )' >$tag</a> </span>";
		} else {
	...
	function renderPrev($tag = '‹') {
		...
		if ($this->page > 1) {
            ...
            $pageno = $this->page - 1;
            return " <span><a href='javascript:void(0);' OnClick='getdata( $pageno )' title='Previous Page'>$tag</a> </span>";
		} else {
			return "<span class='disabled'>$tag</span> ";
		}
	}
	...
	function renderNav() {
		...
		for($i = $start; $i <= $end; $i ++) {
			if ($i == $this->page) {
                ...
                //$pageno = $this->page + 1;
                $links .= "<span><a href='javascript:void(0);' OnClick='getdata( $i )' title='Another page'>$i</a></span> ";
			}
		}
